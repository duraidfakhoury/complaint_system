...
class AppColors {
  static const Color navy = Color.fromARGB(255, 13, 1, 50);
  static const Color navyAccent = Color.fromARGB(255, 25, 3, 89);
  ...
  static const Color yellow = Color.fromARGB(255, 197, 177, 0);
